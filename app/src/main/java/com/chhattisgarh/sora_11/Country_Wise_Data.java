...
public class Country_Wise_Data extends AppCompatActivity {
    DecimalFormat formatter = new DecimalFormat("#,##,###");
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_country__wise__data);
    ...
    public void init() {
        ...
        tableData = bgfetch.fetchCountryData("state", sortBy, sortOrder);
        ...
        tv0.setPadding(150,0,0,0);
        tv0.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Country_Wise_Data.this, "Sorted by: Country", Toast.LENGTH_SHORT).show();
                // String sortOrder = getIntent().getStringExtra("sortOrder");
                // if(sortOrder.equals("DESC"))
                // arrangeData("state", "ASC");
                // else if(sortOrder.equals("ASC")){
                arrangeData("Country", "DESC");
                // }
        ...
        tv1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Country_Wise_Data.this, "Sorted by: Confirmed", Toast.LENGTH_SHORT).show();
        ...
        tv4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Country_Wise_Data.this, "Sorted by: Active", Toast.LENGTH_SHORT).show();
        ...
        tv3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Country_Wise_Data.this, "Sorted by: Recovered", Toast.LENGTH_SHORT).show();

//                if(sortOrder.equals("DESC"))
//                    arrangeData("recovered", "ASC");
//                else if(sortOrder.equals("ASC"))
        ...
        if(sortBy.equals("death"))
            ...
            tv2.setText("  Death ");
        tv2.setTextColor(Color.rgb(255, 0, 34));
        tv2.setTextSize(20);
        tv2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Country_Wise_Data.this, "Sorted by: Death", Toast.LENGTH_SHORT).show();

//                if(sortOrder.equals("DESC"))
//                    arrangeData("death", "ASC");
//                else if(sortOrder.equals("ASC"))
    ...
    public void arrangeData(String sortBy, String sortOrder){
        Intent i = new Intent(Country_Wise_Data.this,Country_Wise_Data.class);
